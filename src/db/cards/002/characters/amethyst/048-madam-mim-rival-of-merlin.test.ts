...
describe("Madam Mim - Rival of Merlin", () => {
  it("**GRUESOME AND GRIM** ↷ − Play a character with cost 4 or less for free. They gain **Rush**. At the end of the turn, banish them. _They can challenge the turn they're played._'", async () => {
