...
describe("Donald Duck - Musketeer Soldier", () => {
  it("**Bodyguard** _(This character may enter play exerted. An opposing character who challenges one of your characters must choose one with Bodyguard if able.)_**WAIT FOR ME!** When you play this character, chosen character gets +1 ◆ this turn.", () => {
