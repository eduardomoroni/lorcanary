...
function Navbar() {
  return (
    <nav className="fixed left-0 top-0 z-20 mx-auto flex w-full items-center border-b-4 border-border dark:border-darkNavBorder bg-main dark:bg-secondaryBlack px-5 h-16 ">
